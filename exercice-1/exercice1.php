        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                <ul class="navbar-nav fs-4">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/exercice-10/index.php">Exercice 10</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col">
                ...
                <p class="text-center fs-4">Créer un tableau <strong>months</strong> et l'initialiser avec les valeurs suivantes : <br>
                    janvier <br>
                    février <br>
                    mars <br>
                    avril <br>
