...
<body>
    <nav class="navbar navbar-expand-lg bg-body-secondary d-flex">
        <div class="container-fluid">
            <a class="navbar-brand fs-2" href="#">Les tableaux</a>
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                <ul class="navbar-nav fs-4">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/exercice-9/index.php">Exercice 9</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/exercice-10/index.php">Exercice 10</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col">
                <h1 class="text-center p-5">Exercice 10</h1>
                <p class="text-center fs-4">
                    Avec le tableau de l'exercice 5, afficher toutes les valeurs de ce tableau ainsi que les clés associés.   <br>
                    Cela pourra être, par exemple, de la forme : Le département + <strong>nom du département</strong> + a le numéro + <strong>numéro du département</strong>
                </p>
            </div>
        </div>
    </div>
